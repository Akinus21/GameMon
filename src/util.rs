...
//                 while attempts < 4 {
//                     match check_and_set_gdk_backend(&display_server) {
//                         Ok(()) => {
...
//                 // Retry to initialize GTK after setting GDK_BACKEND
//                 println!("GDK_BACKEND matches display server (x11)... Retrying. Attempt: {}", attempts + 1);
//                 if let Err(err) = gtk_init() {
//                     if attempts == 3 {
//                         return Err(format!("Failed to initialize GTK after {} attempts. Error: {}", attempts + 1, err));
//                     }
...
//                 println!("GDK_BACKEND is {}, and NOT {}. Setting GDK_BACKEND to '{}'.", value, expected_backend, expected_backend);
...
// pub fn gtk_init() -> Result<(), glib::BoolError> {
//     gtk4::init()
// }
